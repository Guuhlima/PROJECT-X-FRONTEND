...
export default function ComposerBox({
    ...
    return (
        <div className="bg-white rounded-2xl shadow-md border border-neutral-200 relative">
            <div className="flex">
                <textarea
                    ref={ref}
                    value={value}
            ...
            <div className="flex gap-2 items-center absolute right-2 bottom-2">
                ...
                <button
                    ...
                    onClick={onSend}
                    disabled={disabled}
                    className="bg-neutral-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-full text-white w-8 h-8 p-2"
                    aria-label="Send"
                >
